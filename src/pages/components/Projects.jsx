        ...
        <section className="team-section" id="team-section">
            <div className="max-width">
                ...
                <div className="carousel owl-carousel">
                    <div className="card">
                        <div className="box">
                            <img src={image1} alt="profile 1" style={{width:'100%', height:'100%'}}/>
                        ...
                        <Link to="https://github.com/namfrans/task-manager-app">View</Link>
                    </div>
                    <div className="card">
                        <div className="box">
                            <img src={image1} alt="profile 2" style={{width:'100%', height:'100%'}}/>
                        ...
                        <Link to="https://github.com/namfrans/chat-app">View</Link>
                    </div>
                    <div className="card">
                        <div className="box">
                            <img src={image3} alt="profile 3" style={{width:'100%', height:'100%'}}/>
                        ...
                        <Link to="https://github.com/namfrans/notepad-io">View</Link>
                    </div>
                    <div className="card">
                        <div className="box">
                            <img src={image4} alt="profile 4" style={{width:'100%', height:'100%'}}/>
                        ...
                        <Link to="https://github.com/namfrans/responsive-web-design/tree/main/Product-Landing-Page">View</Link>
                    </div>
                    <div className="card">
                        <div className="box">
                            <img src={image5} alt="profile 5" style={{width:'100%', height:'100%'}}/>
                        ...
                        <Link to="https://github.com/namfrans/responsive-web-design/tree/main/Survey-Page/Survey%20form">View</Link>
                    </div>
                    <div className="card">
                        <div className="box">
                            <img src={image6} alt="profile 5" style={{width:'100%', height:'100%'}}/>
                        ...
                        <Link to="https://github.com/namfrans/simons-game">View</Link>
                    </div>
                </div>
            </div>
        </section>
